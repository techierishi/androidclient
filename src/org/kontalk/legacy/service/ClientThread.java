...
import org.kontalk.legacy.client.ClientHTTPConnection;
...
import org.kontalk.legacy.client.BoxProtocol.BoxContainer;
import org.kontalk.legacy.client.Protocol.Mailbox;
import org.kontalk.legacy.client.Protocol.NewMessage;
import org.kontalk.legacy.client.Protocol.Ping;
import org.kontalk.legacy.client.Protocol.Pong;
                        ...
                        synchronized (mPackLock) {
                            ...
                            try {
                                ...
                                Class<? extends MessageLite> msgc = (Class<? extends MessageLite>) Thread.currentThread()
                                        .getContextClassLoader().loadClass("org.kontalk.legacy.client.Protocol$" + name);
